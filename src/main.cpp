...
int main(int argc, char *argv[])
{
    ...
    QString qmFilePath = QString("%1/%2.qm").arg("/usr/share/long-statusbar/translations/").arg(QLocale::system().name());
    ...
    if (!QDBusConnection::sessionBus().registerService("com.long.Statusbar")) {
        return -1;
    }
