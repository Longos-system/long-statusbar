    ...
    RowLayout {
        ...
        StandardItem {
            ...
            Layout.preferredWidth: Math.min(rootItem.width / 3,
                                            acticityLayout.implicitWidth + LongUI.Units.largeSpacing)
            onClicked: {
        ...
        Item {
            ...
            ListView {
                ...
                delegate: StandardItem {
                    id: _menuItem
                    width: _actionText.width + LongUI.Units.largeSpacing
        ...
        StandardItem {
            ...
            animationEnabled: true
            Layout.fillHeight: true
            Layout.preferredWidth: _controlerLayout.implicitWidth + LongUI.Units.largeSpacing
        ...
        StandardItem {
            ...
            animationEnabled: true
            Layout.fillHeight: true
            Layout.preferredWidth: shutdownIcon.implicitWidth + LongUI.Units.smallSpacing
        ...
        StandardItem {
            ...
            animationEnabled: true
            Layout.fillHeight: true
            Layout.preferredWidth: _dateTimeLayout.implicitWidth + LongUI.Units.smallSpacing

            onClicked: {
                process.startDetached("long-notificationd", ["-s"])
            }
