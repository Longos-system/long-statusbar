...
ControlCenterDialog {
    ...
    Rectangle {
        ...
        color: LongUI.Theme.darkMode ? "#4D4D4D" : "#F0F0F0"
        // opacity: windowHelper.compositing ? LongUI.Theme.darkMode ? 0.6 : 0.8 : 1.0
        opacity: 0.5
        antialiasing: true
        ...
        Item {
            ...
            RowLayout {
                ...
                IconButton {
                    ...
                    source: "qrc:/images/" + (LongUI.Theme.darkMode ? "dark/" : "light/") + "settings.svg"
                    onLeftButtonClicked: {
...
//                    implicitHeight: topItem.height
//                    Layout.alignment: Qt.AlignTop
//                    source: "qrc:/images/" + (LongUI.Theme.darkMode ? "dark/" : "light/") + "system-shutdown-symbolic.svg"
//                    onLeftButtonClicked: {
//                        control.visible = false
//                        process.startDetached("Long-shutdown")
//                    }
//                }
            }
        }
        ...
        Item {
            ...
            Rectangle {
                ...
                opacity: LongUI.Theme.darkMode ? 0.2 : 0.7
            }
            ...
            GridLayout {
                ...
                CardItem {
                    ...
                    icon: LongUI.Theme.darkMode || checked ? "qrc:/images/dark/network-wireless-connected-100.svg"
                ...
                CardItem {
                    ...
                    Layout.fillHeight: true
                    Layout.preferredWidth: cardItems.cellWidth
                    icon: LongUI.Theme.darkMode || checked ? "qrc:/images/dark/bluetooth-symbolic.svg"
                ...
                CardItem {
                    ...
                    Layout.fillHeight: true
                    Layout.preferredWidth: cardItems.cellWidth
                    icon: LongUI.Theme.darkMode || checked ? "qrc:/images/dark/dark-mode.svg"
                                                           : "qrc:/images/light/dark-mode.svg"
                    checked: LongUI.Theme.darkMode
                    label: qsTr("Dark Mode")
                    onClicked: appearance.switchDarkMode(!LongUI.Theme.darkMode)
                }

                CardItem {
                    Layout.fillHeight: true
                    Layout.preferredWidth: cardItems.cellWidth
                    icon: LongUI.Theme.darkMode || checked ? "qrc:/images/dark/do-not-disturb.svg"
                ...
                CardItem {
                    Layout.fillHeight: true
                    Layout.preferredWidth: cardItems.cellWidth
                    icon: LongUI.Theme.darkMode || checked ? "qrc:/images/dark/screenshot.svg"
                                                           : "qrc:/images/light/screenshot.svg"
                    checked: false
                    label: qsTr("Screenshot")
                    onClicked: {
                        control.visible = false
                        process.startDetached("Long-screenshot", ["-d", "500"])
                    }
                }
            }
        }
        ...
        Item {
            ...
            RowLayout {
                ...
                Image {
                    ...
                    source: "qrc:/images/" + (LongUI.Theme.darkMode ? "dark" : "light") + "/brightness.svg"
                    smooth: false
                    antialiasing: true
                }
        ...
        Item {
            ...
            RowLayout {
                ...
                Image {
                    ...
                    width: height
                    sourceSize: Qt.size(width, height)
                    source: "qrc:/images/" + (LongUI.Theme.darkMode ? "dark" : "light") + "/" + control.volumeIconName + ".svg"
                    smooth: false
                    antialiasing: true
                }
...
//                }
        ...
        RowLayout {
            ...
            Layout.rightMargin: LongUI.Units.smallSpacing
            spacing: 0

            Label {
                id: timeLabel
                leftPadding: LongUI.Units.smallSpacing / 2
            ...
            StandardItem {
                width: batteryLayout.implicitWidth + LongUI.Units.largeSpacing
                height: batteryLayout.implicitHeight + LongUI.Units.largeSpacing
                ...
                RowLayout {
                    ...
                    Image {
                        ...
                        height: 16
                        sourceSize: Qt.size(width, height)
                        source: "qrc:/images/" + (LongUI.Theme.darkMode ? "dark/" : "light/") + battery.iconSource
                        asynchronous: true
                    ...
                    Label {
                        ...
                        color: LongUI.Theme.textColor
                        rightPadding: LongUI.Units.smallSpacing / 2
                        Layout.alignment: Qt.AlignHCenter | Qt.AlignVCenter
                    }
                }
            }
